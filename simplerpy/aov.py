...
class AOV:
  ...
  def df(self):
    """
    Returns the degrees of freedom on the feature variables of the fitted model,
  ...
  def df_residual(self):
    """
    Returns the degrees of freedom on residuals of the fitted model, retrieved
  ...
  def sum_of_squares(self):
    ...
    Returns the sum of squares based on the fitted model, retrieved from the R 
    model object.
  ...
  def residual_se(self):
    """
    Returns the residual standard errors from the fitted model, retrieved from
    the R model object
  ...
  def summary(self):
    ...
    output+=f"{str(AOV.df_residual(self)):>{maxLength}}" + "\n" + "\n" + \
